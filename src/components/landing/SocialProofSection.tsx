...
const proofCards = [
  ...
  {
    type: "Patient fibroid scan",
    label: "Proof 1",
    image: proof1,
    note: "Scan image showing fibroid condition before support.",
  },
  {
    type: "Patient recovery scan",
    label: "Proof 2",
    image: proof2,
    note: "After image shared by a woman who reported she is now fine.",
  },
  {
    type: "Video story",
